...
@endif
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <form method="POST" action="{{ route('register') }}" class="bg-white p-6 rounded shadow w-full max-w-md">
            ...
            @csrf
            <input type="text" name="name" placeholder="Nom complet" class="w-full border mb-3 p-2" required>
            ...
            <input type="password" name="password_confirmation" placeholder="Confirmer le mot de passe" class="w-full border mb-3 p-2" required>
